           ...
           try {
               ...
               if(arrv[0].endsWith('saveAufn')) {
                   ...
                   transfer = 'successfull';
                         ...
                         await collection
                                .updateOne({ [arrk[2]]: arrv[2] }, { $pull:{Konsultation: {[arrk[3]] : arrv[3], [arrk[4]] : arrv[4], [arrk[5]] : arrv[5], [arrk[6]] : arrv[6] }} })
                                .catch(err=>console.log('delete failed: '+err))

                         await collection
                                .updateOne({ [arrk[2]]: arrv[2] }, { $push:{Konsultation: {[arrk[3]] : arrv[3], [arrk[4]] : arrv[4], [arrk[5]] : arrv[5], [arrk[6]] : arrv[6] }} })
                                .catch(err=>console.log('insert failed: '+err))
                         transfer = 'successfull';
               }
